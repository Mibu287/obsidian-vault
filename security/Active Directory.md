...
- Administrator can set policies for OUs, users, devices. E.g. users in accounting department can access accounting software but not customer relation management system (CRM). Only, users from 
- When a new users/machines are added to the domain 